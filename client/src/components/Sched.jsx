        ...
        className='w-full'>
            {(loginStatus == "") ? (
                <div className='flex flex-col'>
                    <Nav className='self-center lg:self-start text-white' text='hidden lg:flex'/>
                    <div className="text-center font-poppins xxs:bg-cente bg-npoc--appointment__page bg-cover bg-no-repeat w-full h-screen flex flex-col justify-center">
                        ...
                        <main className='grid place-items-center h-5/6 text-white'>
                            <div className='font-gilmer text-xl flex flex-col items-center h-full w-5/6 pt-5 bg-gray-900/75 rounded-2xl overflow-auto'>
                                ...
                                <Link to="/slots" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center mb-5 text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Add
